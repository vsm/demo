...
function vsmExamplesList(opt) {
  ...
  var vsmExamples = [
    ...
    // --- The introductory 'John eats chicken' example.
    {
      terms: [
        ...
        { str: 'eats',    classID: 'http://purl.obolibrary.org/obo/RO_0002470',
          dictID: 'http://data.bioontology.org/ontologies/RO',
          instID: null,
          descr: 'an eating activity, to eat' },
        { str: 'chicken', classID: 'http://purl.obolibrary.org/obo/FOODON_03411457',
          instID: null,
          dictID: 'http://data.bioontology.org/ontologies/FOODON',
    ...
    { terms: [
        { str: 'leaf lamina',
          classID: 'http://purl.obolibrary.org/obo/PO_0020039',
          instID: null,
          dictID: 'http://data.bioontology.org/ontologies/PO',
          descr: 'The blade or flat part of a leaf.' },
        { str: 'is',
          classID: 'http://example.org/ID/has_state',
          instID: null,
          dictID: 'http://example.org',
          descr: 'to be in the given state' },
        { str: 'twisted',
          classID: 'http://purl.obolibrary.org/obo/PATO_0002445',
          instID: null,
          dictID: 'http://data.bioontology.org/ontologies/PATO',
          descr: 'The shape of being twisted or turned. Synonym of: torsioned.'},
        { str: 'in',
          classID: 'http://example.org/ID/pertains_to',
          instID: null,
          dictID: 'http://example.org',
          descr: 'pertains to' },
        { str: 'Rice',
          classID: 'http://purl.obolibrary.org/obo/NCBITaxon_4530',
          instID: null,
          dictID: 'http://data.bioontology.org/ontologies/NCBITaxon',
          descr: 'The species \'Oryza sativa\'. Synonyms: rice, red rice.' },
        { str: 'underexpressing',
          classID: 'http://purl.obolibrary.org/obo/PHI_2000012',
          instID: null,
          dictID: 'http://data.bioontology.org/ontologies/PHI',
          descr: 'Synonym: Gene downregulation.' },
        { str: 'YAB3',
          classID: 'https://www.araport.org/locus/AT4G00180',
          instID: null,
          dictID: 'https://www.araport.org' },
        { str: 'by',
          classID: 'https://en.wiktionary.org/wiki/by_means_of',
          instID: null,
          dictID: 'https://en.wiktionary.org',
          descr: 'by means of' },
        { str: 'RNAi',
          classID: 'http://edamontology.org/topic_3523',
          instID: null,
          dictID: 'http://edamontology.org',
    ...
    // --- Inspired by the GO-CAM data model.
    {
      terms: [
        { str: 'UV',
          ...
          instID: null,
          dictID: 'http://data.bioontology.org/ontologies/ZECO',
        ...
        { str: 'RNA Polymerase II',
          ...
          instID: 'db-id225',
          dictID: 'http://data.bioontology.org/ontologies/NCIT' },
        { str: 'in',
    ...
    { terms: [
        ...
        { queryOptions: { filter: { dictID: [
            ...
            'http://data.bioontology.org/ontologies/RO'
          ] } },
