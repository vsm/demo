...
function vsmExamplesList(opt) {
  ...
  var vsmExamples = [
    ...
    // --- Inspired by the GO-CAM data model.
    {
      terms: [
        ...
        { str: 'it',
          ...
          instID: 'db-id229',
          parentID: 'db-id225',
          descr: 'Refers to a (in a new local context): RNA Polymerase II' },
        { str: 'activates',
    ...
    { terms: [
        ...
        { str: '<=>',               classID: 'https://en.wikipedia.org/wiki/Reversible_reaction', instID: null,
          descr: 'Synonyms: ⇄, ⇌, reversibly reacts to, reversible reaction.' },
